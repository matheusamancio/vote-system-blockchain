...
class ninthQuizViewController:BaseViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    private let tableView: UITableView = {
        ...
        tb.rowHeight = 65
        tb.register(ninthQuizTableCell.self, forCellReuseIdentifier: "ninthQuizTableCell")
    ...
    fileprivate let nextButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(goToTenth), for: .touchUpInside)
        return button
    }()
    ...
    override func viewDidLoad() {
        ...
        self.title = "Simpatia com algum Partido?"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let cell = tableView.cellForRow(at: indexPath)  as? ninthQuizTableCell
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ninthQuizTableCell", for: indexPath as IndexPath) as? ninthQuizTableCell
    ...
    @objc func goToTenth(){
        let tq = tenthQuizViewController()
